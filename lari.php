...
[
	[
		'codPedido' => 123, 
		'descricao' => 'AD 054227 PROMOCAO'
	],[
		'codPedido' => 345, 
		'descricao' => 'AD 018239 NORMAL'
	]
];


$arrayToXml = new ArrayToXml($pedido, 'pedido');
$arrayToXml->setDomProperties(['formatOutput' => true]);
echo $arrayToXml->save('pedido.xml'); //salva o arquivo

echo $arrayToXml->toXML(); //mostra na tela
